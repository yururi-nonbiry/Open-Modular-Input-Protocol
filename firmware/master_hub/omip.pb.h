...
#ifndef PB_OMIP_OMIP_PB_H_INCLUDED
#define PB_OMIP_OMIP_PB_H_INCLUDED
#include <pb.h>
...
#define omip_FeedbackImage_init_default          {0, 0, _omip_FeedbackImage_ImageFormat_MIN, {{NULL}, NULL}}
...
#define omip_FeedbackImage_init_zero             {0, 0, _omip_FeedbackImage_ImageFormat_MIN, {{NULL}, NULL}}
...
#define omip_FeedbackImage_image_data_tag        4
...
X(a, CALLBACK, SINGULAR, BYTES,    image_data,        4)
#define omip_FeedbackImage_CALLBACK pb_default_field_callback
...
/* omip_FeedbackImage_size depends on runtime parameters */
/* omip_DeviceCapabilityResponse_size depends on runtime parameters */
#define OMIP_OMIP_PB_H_MAX_SIZE                  omip_InputEncoder_size
